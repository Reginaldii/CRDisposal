  ...
  return (
    <section id="about" className="section bg-ink-50 dark:bg-ink-800 scroll-mt-16">
      <div className="container-x grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
        <PhotoPlaceholder label="CR Disposal Dump Truck & Crew" variant="dark" ratio="aspect-[4/3]" />
        <div>
          <p className="eyebrow">About CR Disposal</p>
          <h2 className="mt-4 font-display text-3xl font-extrabold tracking-tight sm:text-4xl">
            One truck. No runaround.
          </h2>
          <p className="mt-5 text-[15px] leading-relaxed text-ink-600 dark:text-ink-200">
            CR Disposal is a locally owned junk removal company running a 2011 Ford F350 4x4 mason
            dump truck across the Lehigh Valley. No call centers, no vague pricing, no waiting
            around — just a crew that shows up, does the heavy lifting, and leaves the space clean.
          </p>
